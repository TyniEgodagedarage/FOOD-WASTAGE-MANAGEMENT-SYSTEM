                ...
                <div className={`container ${signInpanelOpened}`}>
                    ...
                    <div className="form-container sign-in-container">
                        <form onSubmit={(e) => { e.preventDefault(); signInUser() }}>
                            ...
                            {/* <button className="di_req_now_btn" onClick={openMaps}>
                                    Admin Login  
                                </button> */}
                    ...
                    <div className="overlay-container">
                        <div className="overlay">
                            <div className="overlay-panel overlay-left">
                                <h1>Welcome Back!</h1>
                                <p id="name">To keep connected with us please login with your personal info</p>
                            ...
                            <div className="overlay-panel overlay-right">
                                <h1>Hello, Friend!</h1>
                                <p id="name">Enter your personal details and start journey with us</p>
                                {/* <button onClick={openSignUpPanel} className="ghost">Sign Up</button> */}
                                {/* <button className="ghost"> <a href="https://email-otp.herokuapp.com/">Send OTP</a></button> */}
                            </div>
                        </div>
                    </div>
                    {/* ignore just for animation pupose */}
