                    ...
                    <form onSubmit={(e) => { e.preventDefault(); updateProfile() }}>
                        ...
                        <DialogContent style={{ padding: "0px" }} >
                            <div id="alert-dialog-slide-description">
                                <p style={{ opacity: "0.7", padding: "0px 10px" }}><b>NOTE: 
                                    </b>High resolution image takes much to upload, please be patient</p><br />
                                <input style={{ width: "100%", margin: "auto", paddingLeft: "10px" }}
                                 type="file" onChange={(e) => { setImage(e.target.files[0]); 
                                    setValid(true); setImageChange(true) }} /><br /><br />
                                <img width="100%" height="200px" style={{ textAlign: "center",
                                 padding: "10px", objectFit: "contain", cursor: "pointer" }} alt="img" src={uploadImageURL(image)} />
                                <br /><br />
                                <TextField
                                ...
                                />
                            <input type="text" id="currentpwd" name="cpw" placeholder='Current Password'/> 
                             <input type="text" id="newpwd" name="npwd" placeholder='New password'/>
                            </div>
                        </DialogContent>
                        <DialogActions>
